...
export const en = {
	...
	mentoring: {
		...
		list: {
			...
			data: [
				"1. Обучение: Наставник может обеспечить индивидуальный подход к каждому сотруднику, помогая ему изучить новые технологии и навыки, необходимые для выполнения своих задач. Кроме того, наставник может поделиться своим опытом и знаниями, чтобы помочь сотруднику быстрее адаптироваться к новой среде.",
				"2. Мотивация: Поддержка наставника может способствовать мотивации сотрудников, предоставляя им обратную связь и поддержку, когда они сталкиваются с трудностями или неудачами. Это помогает сотрудникам сохранять мотивацию и продолжать работать над своими целями.",
				"3. Развитие карьеры: Наставники могут помочь сотрудникам развивать свою карьеру, предлагая рекомендации по карьерному росту, возможностям обучения и развития. Они также могут предоставить советы по улучшению навыков и повышению квалификации.",
				"4. Укрепление команды: Поддержка наставника способствует укреплению команды, поскольку сотрудники чувствуют себя более уверенно и уверенно в своих способностях. Это может привести к повышению производительности и улучшению качества работы.",
				"5. Поддержка в трудные времена: В IT-компаниях часто возникают трудные моменты, такие как изменения в бизнес-стратегии или технологические изменения. Поддержка наставника помогает сотрудникам справляться с этими вызовами, предоставляя советы и поддержку в сложных ситуациях. Поддержка наставника является важным элементом успешной работы в IT-компаниях. Она помогает сотрудникам развиваться, достигать своих целей и укреплять команду."
			],
		}
	}
};